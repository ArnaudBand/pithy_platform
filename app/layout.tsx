...
const SITE_NAME = 'Pithy Means Africa';
...
export const generateMetadata = ({
  ...
  return {
    ...
    title: {
      default: title,
      template: '%s | Pithy Means Africa - Personal Development Experts',
    },
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Pithy Means Africa - Expert Personal Development Platform',
          type: 'image/png',
        },
        {
          url: `${SITE_URL}/opengraph-image.png`,
